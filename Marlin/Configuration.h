...
#define STRING_CONFIG_H_AUTHOR "(Casa Dimis)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 414, 395 }
...
#define NOZZLE_TO_PROBE_OFFSET {-20,-14,-1.8}
